...
<!--            		 <span> 1</span>小时<span>32</span>分 -->
      ...
      <div class="course_intro">
        ...
        <div class="curse_btn">
			 <a href="${pageContext.request.contextPath}/order!forwardSureOrder.html?product.id=${product.id}" >立即购买</a>
        </div>
      </div>
  </div>   
      ...
      <div class="outline">
        ...
        <div class="course_shortdecription">
         	<table align="center" width="100%" border="0">
         		<tr>
         			<td width="150px" align="left">上线时间：<s:date name="product.onlineTime" format="yyyy-MM-dd" /></td>
<!--          			<td align="left"></td> -->
         			<td  width="150px" align="left">下线时间：<s:date name="product.offlineTime" format="yyyy-MM-dd" /></td>
<%--          			<td align="left"><s:date name="product.offlineTime" format="yyyy-MM-dd" /></td> --%>
         			<td  width="150px" align="left">更新时间：<s:date name="product.updateTime" format="yyyy-MM-dd" /></td>
<!--          			<td align="left"></td> -->
         		</tr>
         		<tr></tr>
         	</table>
        ...
        <h3 class="chapter_catalog">课程详情</h3>
        	<ul id="couList">
        		<s:iterator value="product.productDetailImageList" id="image">
        			<li>
        				<img alt="" src="${pageContext.request.contextPath}/product!showProductDetailImage.html?productDetailImage.id=${image.id}">
        			</li>
        		</s:iterator>
        	</ul>
		...
		<h3>课程精彩截图</h3>
        	<ul id="couList">
        		<s:iterator value="product.productDetailAvatarList" id="image">
        			<li>
        				<img alt="" src="${pageContext.request.contextPath}/product!showProductDetailAvatar.html?productDetailAvatar.id=${image.id}">
        			</li>
        	</s:iterator>
        </ul>
        	    </div>
          ...
          <dd>
              <div class="course_teacher">
                <a href="#" class="teacer_pic">
                	<img src='${pageContext.request.contextPath}/product!showEmpHeader.html?employee.id=${employee.id}' width='80' height='80' /></a>
                <h3>
...
<!--           	<pre class="wrd_break"> -->
				<table >
					...
					<tr height="50px">
						<td><button type="button" class="btn btn-danger" style="float: right;">评论</button></td>
					</tr>
				</table>
