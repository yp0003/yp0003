...
<div class="content">
   <div class="cidnav">
   		    <ul>                
                <li><span class="cidcolor">付款</span></li>     
                 <li><span>></span></li>                
                <li><span class="orther">确认订单信息</span></li>
                 <li><span>></span></li>     
    ...
    <div class="taba">
			<div class="title">
				<ul class="fn-clear tab-ul">
					<li class="def tab-z" n="1">支持银行</li>
					<li class="tab-z" n="2">第三方</li>
				</ul>
			</div>
                ...
                <ul class="nCard-list nCard-last clearfix">
                    <li class="bankCard nCardCil" data-gateway="0005">
                        <label title="工商银行" for="bank_0005">
                            <input id="bank_0005" class="nRadio" type="radio" checked="checked"
                             data-name="工商银行" name="myCard" value="0005"></input>
                            <img src="${pageContext.request.contextPath}/image/card/bank_5.gif" alt="工商银行"></img>
                        </label>
                   ...
                   <li class="bankCard " data-gateway="0007">
                        <label title="招商银行" for="bank_0007">
                            ...
                            <img src="${pageContext.request.contextPath}/image/card/bank_11.gif" alt="招商银行"></img>
                        </label>
                        <span class="nCard-tips"></span>
                    </li>
                    <li class="bankCard " data-gateway="4008">
                        ...
                        <label title="农业银行" for="bank_4008">
                            ...
                            <img src="${pageContext.request.contextPath}/image/card/bank_17.gif" alt="农业银行"></img>
                        </label>
                        <span class="nCard-tips"></span>
                    ...
                    <li class="bankCard " data-gateway="1025">
                        ...
                        <label title="交通银行" for="bank_1025">
                            ...
                            <img src="${pageContext.request.contextPath}/image/card/bank_9.gif" alt="交通银行"></img>
                        </label>
                        <span class="nCard-tips"></span>
                    ...
                    <li class="bankCard " data-gateway="1023">
                        ...
                        <label title="中国银行" for="bank_1023">
                            ...
                            <img src="${pageContext.request.contextPath}/image/card/bank_8.gif" alt="中国银行"></img>
                        </label>
                        <span class="nCard-tips"></span>
                    ...
                    <li class="bankCard " data-gateway="0031">
                        ...
                        <label title="平安银行" for="bank_0031">
                            ...
                            <img src="${pageContext.request.contextPath}/image/card/bank_60.gif" alt="平安银行"></img>
                        </label>
                        <span class="nCard-tips"></span>
                    ...
                    <li class="bankCard " data-gateway="1022">
                        ...
                        <label title="浦东发展银行" for="bank_1022">
                            ...
                            <img src="${pageContext.request.contextPath}/image/card/bank_4.gif" alt="浦东发展银行"></img>
                        </label>
                        <span class="nCard-tips"></span>
                    ...
                    <li class="bankCard " data-gateway="0015">
                        ...
                        <label title="中国民生银行" for="bank_0015">
                            ...
                            <img src="${pageContext.request.contextPath}/image/card/bank_18.gif" alt="中国民生银行"></img>
                        </label>
                        <span class="nCard-tips"></span>
                    ...
                    <li class="bankCard " data-gateway="1010">
                        ...
                        <label title="中国建设银行" for="bank_1010">
                            ...
                            <img src="${pageContext.request.contextPath}/image/card/bank_6.gif" alt="中国建设银行"></img>
                        </label>
                        <span class="nCard-tips"></span>
                    ...
                    <li class="bankCard " data-gateway="0030">
                        ...
                        <label title="上海银行" for="bank_0030">
                            ...
                            <img src="${pageContext.request.contextPath}/image/card/bank_21.gif" alt="上海银行"></img>
                        </label>
                        <span class="nCard-tips"></span>
                    ...
                    <li class="bankCard " data-gateway="0009">
                        ...
                        <label title="兴业银行" for="bank_0009">
                            ...
                            <img src="${pageContext.request.contextPath}/image/card/bank_12.gif" alt="兴业银行"></img>
                        </label>
                        <span class="nCard-tips"></span>
                    ...
                    <li class="bankCard " data-gateway="0027">
                        ...
                        <label title="光大银行" for="bank_0027">
                            ...
                            <img src="${pageContext.request.contextPath}/image/card/bank_13.gif" alt="光大银行"></img>
                        </label>
                        <span class="nCard-tips"></span>
                    ...
                    <li class="bankCard " data-gateway="0026">
                        ...
                        <label title="广发银行" for="bank_0026">
                            ...
                            <img src="${pageContext.request.contextPath}/image/card/bank_3.gif" alt="广发银行"></img>
                        </label>
                        <span class="nCard-tips"></span>
			...
			<div class="sp fn-clear taba z_2">
				 ...
				 <ul class="nCard-list nCard-last clearfix">
                    ...
                    <li class="bankCard nCardCil" >
                        <label title="在线支付平台" for="100100_platform">
                            ...
                            <img src="${pageContext.request.contextPath}/image/card/bank_0.gif" alt="在线支付平台"></img>
                        </label>
                        <span class="nCard-tips"></span>
                    </li>
                   <li class="bankCard " >
                        ...
                        <label title="支付宝" for="100112_platform">
                            ...
                            <img src="${pageContext.request.contextPath}/image/card/zfb2.gif" alt="支付宝"></img>
                        </label>
                        <span class="nCard-tips"></span>
