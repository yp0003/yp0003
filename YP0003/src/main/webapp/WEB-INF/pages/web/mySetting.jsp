...
<div id="setting-profile" class="setting-wrap setting-profile">
   	<s:form action="/mycenter!updateInfo.html">
    	...
    	<div class="wlfg-wrap">
    		 ...
    		 <div class="rlf-group">
            	<s:textfield disabled="true" name="user.userId" id="userId" autocomplete="off"  data-validate="nick"  class="rlf-input rlf-input-nick" placeholder="请输入昵称."></s:textfield>
        ...
        <div class="wlfg-wrap">
            ...
            <div class="rlf-group">
            	<s:textfield name="user.nick" id="nick"  autocomplete="off"  data-validate="nick"  class="rlf-input rlf-input-nick" placeholder="请输入昵称."></s:textfield>
<%--                 <input  type="text" name="user.nick" id="nick"  autocomplete="off"  data-validate="nick"  class="rlf-input rlf-input-nick" value='<s:property value="user.nick"/>' placeholder="请输入昵称."/> --%>
        ...
        <div class="wlfg-wrap">
            ...
            <div class="rlf-group">
            		<s:textfield name="user.userName" id="userName"  autocomplete="off"  data-validate="userName"  class="rlf-input rlf-input-nick"  placeholder="请输入用户名."></s:textfield>
<%--                 <input  type="text" name="user.userName" id="userName"  autocomplete="off"  data-validate="userName"  class="rlf-input rlf-input-nick" value='<s:property value="user.userName"/>' placeholder="请输入用户名."/> --%>
                <p class="rlf-tip-wrap"></p>
            </div>
        </div>
          <div class="wlfg-wrap">
            ...
            <div class="rlf-group rlf-radio-group">
                <label ><s:radio list="#{'男':'男','女':'女'}" hidefocus="true" value="1"  name="sex"></s:radio></label>
<!--                 	<input type="radio" hidefocus="true" value="0" checked="checked"  name="sex">保密</label> -->
...
<!--             </div> -->
 			<div class="rlf-group">
                <input  type="text" name="user.provinceAndCity" id="provinceAndCity"  autocomplete="off"  data-validate="provinceAndCity"  class="rlf-input rlf-input-nick" value='<s:property value="user.provinceAndCity"/>' placeholder="请输入所在城市."/>
                <p class="rlf-tip-wrap"></p>
            </div>
        </div>
         ...
         <div class="wlfg-wrap">
            ...
            <div class="rlf-group">
            	<s:textfield name="user.qq" id="qq"  autocomplete="off"  data-validate="qq"  class="rlf-input rlf-input-nick" placeholder="请输入QQ."></s:textfield>
...
<!--         </div> -->
        <div class="wlfg-wrap">
            <div class="rlf-group">
                <span id="profile-submit"  hidefocus="true"  aria-role="button" class="rlf-btn-green btn-block profile-btn" onclick="forSubmit()">保存</span>
            </div>
        </div>
    </s:form>
</div>
