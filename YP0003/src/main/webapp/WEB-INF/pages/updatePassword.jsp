...
<body>
  <s:form action="system!updatePassword.html" id="register">
    ...
    <s:textfield id="passWord" placeHolder="请输入当前密码" name="user.oldPassword" />
    ...
    <s:textfield id="passWord" placeHolder="英文、数字或字符，6-20位区分大小写" name="user.nowPassword" />
    <span class="redStar">*</span>
    ...
    <s:textfield id="passWord" type="password" placeHolder="重复新密码" name="user.nowPassword" />
    <span class="redStar">*</span>
    </li>
