...
<body>
  <s:form action="employee!updateInfo.html" id="register">
    <ul>
    <li>
    <label for="passWord">用户ID:</label>
    <s:textfield id="passWord"  name="employee.empId" readonly="true"/>
    <span class="redStar">*</span>
     <s:if test="infoMessage.employeeIdMessage != null">
      <span class="redStar"><s:property value="infoMessage.employeeIdMessage" /></span>
     </s:if>
    </li>
    <li>
    <label for="passWord">昵称:</label>
    <s:textfield id="passWord"  name="employee.nick" />
    <span class="redStar">*</span>
    ...
    <s:textfield id="passWord"  name="employee.empName" />
    <span class="redStar">*</span>
     <s:if test="infoMessage.employeeNameMessage != null">
      <span class="redStar"><s:property value="infoMessage.employeeNameMessage" /></span>
     </s:if>
    </li>
    <li>
    ...
    <s:radio name="employee.sex" list="#{'0':'男','1':'女'}" value="0"/>
    <span class="redStar">*</span>
    </li>
    <li>
    <label for="passWord">身份证号:</label>
    <s:textfield id="passWord"  name="employee.idcardNumber" />
    <span class="redStar">*</span>
    ...
    <s:select id="passWord" list="#{0:'高中',1:'大专',2:'本科',3:'研究生',4:'博士'}" name="employee.education" />
    <span class="redStar">*</span>
    </li>
    <li>
    <label for="passWord">留学国家:</label>
    <s:textfield id="passWord"  name="employee.foreignCountrie" />
    <span class="redStar">*</span>
    ...
    <s:textfield id="passWord"  name="employee.graduateSchool" />
    <span class="redStar">*</span>
    ...
    <s:textfield id="passWord"  name="employee.phoneNumber" />
    <span class="redStar">*</span>
    ...
    <s:textfield id="passWord"  name="employee.countrie" />
    <span class="redStar">*</span>
    ...
    <s:textfield id="passWord"  name="employee.provinceAndCity" />
    <span class="redStar">*</span>
    ...
    <s:textfield id="passWord"  name="employee.address" />
    <span class="redStar">*</span>
    ...
    <s:textfield id="passWord"  name="employee.zipCode" />
    <span class="redStar">*</span>
    ...
    <s:textfield id="passWord"  name="employee.email" />
    <span class="redStar">*</span>
    ...
    <s:textfield id="passWord"  name="employee.qq" />
    <span class="redStar">*</span>
