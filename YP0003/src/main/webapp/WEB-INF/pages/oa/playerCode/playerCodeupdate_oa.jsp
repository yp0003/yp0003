...
function forSubmit() {
	document.forms[0].action = "oaPlayCode!update.html";
...
<body>
	<s:form method="POST" enctype="multipart/form-data">
		...
		<table align="center" width="100%" cellpadding="5px" border="0">
		    <tr><td>学员账号:</td>
				<td><s:textfield name="myProduct.userId" readonly="true"/><s:actionerror/></td>
			</tr>
		    <tr><td>课程名称:</td>
				<td><s:textfield name="myProduct.product.productName" readonly="true"/><s:actionerror/></td>
			</tr>
		    <tr><td>机器码:</td>
				<td><s:textfield name="myProduct.smartCode" readonly="true"/><s:actionerror/></td>
			</tr>
		    <tr><td>播放码:</td>
				<td><s:textfield name="myProduct.playerCode"/><s:actionerror/></td>
			</tr>
        </table>
            </div>
        </div>
