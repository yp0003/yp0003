			...
			<s:form action="/oalogin!register.html" id="register">
				<ul>
					<li><label for="memberID">会员ID:</label> <s:textfield
							id="memberID" placeHolder="请输入6个以上的字符作为密码"
							name="oaEmployee.employeeId" /> <span class="redStar">*</span></li>
					<li><label for="passWord">密码:</label> <s:textfield
							id="passWord" placeHolder="英文、数字或字符，6-20位区分大小写"
							name="oaEmployee.nowPassword" /> <span class="redStar">*</span></li>
					<li><label for="passWord">确认密码:</label> <s:textfield
							id="passWord" type="password" name="oaEmployee.repassword" /> <span
						class="redStar">*</span></li>
					<li><label for="passWord">电子邮箱:</label> <s:textfield
							id="passWord" placeHolder="请使用常用邮箱地址作为登录账号"
							name="oaEmployee.email" /> <span class="redStar">*</span></li>
					...
					<li>
						<button id="btn_register" type="submit"></button> <br /> <br /> <a
						class="chgForm"
						href="${pageContext.request.contextPath}/oalogin!forwardLogin.html">登录</a>
						<div class="clear"></div>
