				...
				<tr>
					...
					<td  style="border: 0px;padding-right: 210px;height: 50px" align="right">
						<input type="button" value="新增" 
							onclick="window.location.href='oaPublicMessage!forwardAddPulbicMessageInfo.html'" />
					</td>
				</tr>
			</table>
		</fieldset>
	...
	<table id="stupidtable" width="100%" align="center" class="table">
		...
		<thead>
			<tr>
				...
				<th data-sort="string">公告ID</th>
				<th data-sort="string">发送时间</th>
				<th data-sort="string">发送内容</th>

				<th>操作</th>
			</tr>
		</thead>
		<tbody>
			<s:iterator value="publicMessageList" id="pm" status="status" >
					...
					onmouseout="this.bgColor='#FFFFFF'" align="center">
						...
						<td align="center"><s:property value="#pm.publicMessageId"></s:property></td>
						<td align="center"><s:property value="#pm.sendTime"></s:property></td>
						<td align="center"><s:property value="#pm.sendContent"></s:property></td>
