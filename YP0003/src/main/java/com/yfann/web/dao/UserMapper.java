...
public interface UserMapper {
	 ...
	 * @return
	 */
	List<User> selectUserByField(Map<String, Object> map);
	 ...
	 * @return
	 */
	Integer selectUserCountByField(Map<String, Object> map);
	 ...
	 * @return
	 */
	List<User> selectByExample(UserExample userExample, RowBounds rowBounds);
